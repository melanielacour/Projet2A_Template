...
usermovie_router = APIRouter(prefix="/reviews", tags=["MyMovies"])
# Pydantic Models
...
@usermovie_router.post("/movies/add")
...
@usermovie_router.put("/movies/status/{id_film}")
...
@usermovie_router.delete("/movies/delete/{id_film}")
...
@usermovie_router.get("/movies/watchlist/{id_user}", response_model=List[MovieListResponse])
...
@usermovie_router.get("/movies/seenlist/{id_user}", response_model=List[MovieListResponse])
...
@usermovie_router.get("/movies/all_movies/{id_user}", response_model=List[MovieListResponse])
