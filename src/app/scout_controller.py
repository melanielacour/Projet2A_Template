...
@scout_router.delete("/scouts/{id_scout}/unfollow", summary="Ne plus suivre un éclaireur")
...
@scout_router.get("/scouts/{id_scout}/followers", summary="Liste des followers d'un éclaireur")
...
@scout_router.get("/users/{id_follower}/scouts/watchlist", summary="Watchlist des éclaireurs suivis")
